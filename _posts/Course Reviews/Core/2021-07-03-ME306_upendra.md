...
#### Attendence Policy
We did not have an attendance policy earlier, but looking at the low attendence, the professor set up an incentive based attendence policy. Attending more than a certain fraction of the remaining classes got us bonus points.

#### Pre-requisites
ME209, ME219, ME346

#### Evaluation Scheme
6 Quizzes - 10% each, Endsem - 40%, with upto 6 bonus points based on attendence
